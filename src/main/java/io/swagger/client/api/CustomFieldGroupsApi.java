...
import io.swagger.client.model.APICustomFieldGroup;
...
public class CustomFieldGroupsApi {
   ...
   * @return List<APICustomFieldGroup>
   */
  public List<APICustomFieldGroup> getCustomFieldGroups(Integer skip, Integer top, Boolean countTotal) throws ApiException {
    Object postBody = null;
    
    // create path and map variables
    String path = "/CustomFieldGroups".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<APICustomFieldGroup>> returnType = new GenericType<List<APICustomFieldGroup>>() {};
