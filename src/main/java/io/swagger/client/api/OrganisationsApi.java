...
import io.swagger.client.model.APIOrganisation;
...
public class OrganisationsApi {
  ...
  public List<APIOrganisation> getOrganisations(Boolean brief, Integer skip, Integer top, Boolean countTotal) throws ApiException {
    ...
    GenericType<List<APIOrganisation>> returnType = new GenericType<List<APIOrganisation>>() {};
   ...
   */
  public APIOrganisation updateOrganisation(APIOrganisation apiOrganisation, Boolean brief) throws ApiException {
    ...
    GenericType<APIOrganisation> returnType = new GenericType<APIOrganisation>() {};
  ...
  public APIAddress updateAddress(Long id, APIAddress apiAddress) throws ApiException {
    ...
    GenericType<APIAddress> returnType = new GenericType<APIAddress>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
  ...
  public APIContactInfo updateContactInfo(Long id, APIContactInfo apiContactInfo) throws ApiException {
    ...
    GenericType<APIContactInfo> returnType = new GenericType<APIContactInfo>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
  ...
  public APIOrganisationDate updateDate(Long id, APIOrganisationDate apiDate) throws ApiException {
    ...
    GenericType<APIOrganisationDate> returnType = new GenericType<APIOrganisationDate>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
  ...
  public APIOrganisationLink updateOrganisationLink(Long id, APIOrganisationLink apiLink) throws ApiException {
    ...
    GenericType<APIOrganisationLink> returnType = new GenericType<APIOrganisationLink>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
