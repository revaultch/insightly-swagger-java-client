...
public class UsersApi {
  ...
  public List<APIUser> getUsers(Integer skip, Integer top, Boolean countTotal) throws ApiException {
    ...
    GenericType<List<APIUser>> returnType = new GenericType<List<APIUser>>() {};
  ...
  public APIUser getUserMe() throws ApiException {
    ...
    GenericType<APIUser> returnType = new GenericType<APIUser>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
   ...
   * @return APIUser
   */
  public APIUser getUser(Long id) throws ApiException {
    Object postBody = null;
