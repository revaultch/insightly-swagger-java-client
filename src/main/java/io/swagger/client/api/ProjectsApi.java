...
import io.swagger.client.model.APIProject;
...
public class ProjectsApi {
  ...
  public List<APIProject> getProjects(Boolean brief, Integer skip, Integer top, Boolean countTotal) throws ApiException {
    ...
    GenericType<List<APIProject>> returnType = new GenericType<List<APIProject>>() {};
   ...
   * @return APIProject
   */
  public APIProject updateProject(APIProject apiProject, Boolean brief) throws ApiException {
    ...
    GenericType<APIProject> returnType = new GenericType<APIProject>() {};
  ...
  public APIMilestone updateMilestone(Long id, APIMilestone apiMilestone) throws ApiException {
    ...
    GenericType<APIMilestone> returnType = new GenericType<APIMilestone>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
