...
import io.swagger.client.model.APIContact;
...
public class ContactsApi {
  ...
  public List<APIContact> getContacts(Boolean brief, Integer skip, Integer top, Boolean countTotal) throws ApiException {
    ...
    GenericType<List<APIContact>> returnType = new GenericType<List<APIContact>>() {};
   ...
   * @return APIContact
   */
  public APIContact updateContact(APIContact apiContact, Boolean brief) throws ApiException {
    ...
    GenericType<APIContact> returnType = new GenericType<APIContact>() {};
  ...
  public APIContactLink updateContactLink(Long id, APIContactLink apiLink) throws ApiException {
    ...
    GenericType<APIContactLink> returnType = new GenericType<APIContactLink>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
  ...
  public APIContactDate updateDate(Long id, APIContactDate apiContactDate) throws ApiException {
    ...
    GenericType<APIContactDate> returnType = new GenericType<APIContactDate>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
