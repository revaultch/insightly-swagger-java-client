...
import io.swagger.client.model.APILead;
...
public class LeadsApi {
  ...
  public List<APILead> getLeads(Boolean includeConverted, Boolean brief, Integer skip, Integer top, Boolean countTotal) throws ApiException {
    ...
    GenericType<List<APILead>> returnType = new GenericType<List<APILead>>() {};
   ...
   * @return APILead
   */
  public APILead updateLead(APILead apiLead, Boolean brief) throws ApiException {
    ...
    GenericType<APILead> returnType = new GenericType<APILead>() {};
