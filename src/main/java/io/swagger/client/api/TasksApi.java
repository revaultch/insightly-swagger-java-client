...
public class TasksApi {
   ...
   * @return APITask
   */
  public APITask updateTask(APITask apiTask, Boolean brief) throws ApiException {
    ...
    GenericType<APITask> returnType = new GenericType<APITask>() {};
  ...
  public APITaskLink updateTaskLink(Long id, APITaskLink apiLink) throws ApiException {
    ...
    GenericType<APITaskLink> returnType = new GenericType<APITaskLink>() {};
    return apiClient.invokeAPI(path, "PUT", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
